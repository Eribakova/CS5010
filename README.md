...
We wanted to explore how people's social behavior changed with COVID-19, particularly their activity outdoors. In the Washington DC area, there were mixed policies about outdoor social gatherings.  Many parks were closed throughout the summer. However, recreational pathways remained open even when social distancing was not possible, and roads and sidewalks were more open than ever due to reduced automobile traffic.  We examined the public's use of a shared resource, rental bikes, to guage how the public took precautions or increased their risks in response to the pandemic.

Many cities reported a spike in bicycle sales and bike sharing. For example, Chicago reported “unprecedented demand” in its bike-sharing system.  We were curious if the DC area had experienced similar spike or if public health restrictions and precautions - which led reduced tourism and commuting -- caused a net reduction in usage.

Our final objective was to explore use of this data for urban planning and public health policy.  With regard to the latter, healthcare officials could use our data to assess potential risks associated with outdoor recreational behavior.  Our analysis investigates if there has been a spike in leisure biking and whether some of the trails are getting more congested than others. Officials could use this information to a) become more aware of the need to disseminate information on safety precautions outdoors, b) to post safety information posters at the stations that are most frequently used, c) place sanitizing equipment on the most frequent paths. biking activity has increased on the weekend, traffic managers could consider closing part of the roads less used on the weekend by cars to dedicate them to bike use, enabling more social distancing than is possible on trails.  
